...
namespace eCommerce.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            ViewBag.Cinemas = new SelectList(movieDropdownsData.Cinemas, "Id", "Name",1);
            ViewBag.Producers = new SelectList(movieDropdownsData.Producers, "Id", "FullName",1);
            ViewBag.Actors = new SelectList(movieDropdownsData.Actors, "Id", "FullName",1);
